...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7273885db8c752cf81b5ff2ff52d01cd) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["vmnet_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-O2"; "-g"; "-Wall"])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-framework"; "vmnet"])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lwt_vmnet"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "vmnet";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "vmnet"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "vmnet_listen.ml"});
               Executable
                 ({
                     cs_name = "vmnet_write";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "vmnet_write.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ËCSN\023kà\001ÌÿÉRó\159ª\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
